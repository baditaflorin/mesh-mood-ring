...
[![pages](https://img.shields.io/badge/live-baditaflorin.github.io%2Fmesh-mood-ring-b878ff)](https://baditaflorin.github.io/mesh-mood-ring/)
[![version](https://img.shields.io/badge/version-0.1.0-blue)](https://github.com/baditaflorin/mesh-mood-ring/blob/main/package.json)
[![license](https://img.shields.io/badge/license-MIT-green)](./LICENSE)

> Each peer picks a hue; the room's circular-mean color paints the background.

**Live → https://baditaflorin.github.io/mesh-mood-ring/**

**Source → https://github.com/baditaflorin/mesh-mood-ring**
...
git clone https://github.com/baditaflorin/mesh-mood-ring
cd mesh-mood-ring
npm install
npm run dev
```
...
- `mesh-mood-ring:signalingUrl`
- `mesh-mood-ring:turnTokenUrl`
- `mesh-mood-ring:iceServers`
- `mesh-mood-ring:room`
